...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final MAXSwerveModule m_frontLeft = new MAXSwerveModule(
      ...
      DriveConstants.kFrontLeftModuleName, false, true);

  private final MAXSwerveModule m_frontRight = new MAXSwerveModule(
      DriveConstants.kFrontRightDrivingCanId,
      DriveConstants.kFrontRightTurningCanId,
      DriveConstants.kFrontRightCancoderOffset,
      DriveConstants.kFrontRightModuleName, false, true);
  ...
  private final MAXSwerveModule m_backLeft = new MAXSwerveModule(
      ...
      DriveConstants.kBackLeftModuleName, false, true);
  ...
  private final MAXSwerveModule m_backRight = new MAXSwerveModule(
      ...
      DriveConstants.kBackRightModuleName, false, true);
  ...
  public DriveSubsystem() {
    ...
    SmartDashboard.putNumber("DRPOSCONV", ModuleConstants.kDriveMetersPerEncRev);

    SmartDashboard.putNumber("ANGPOSCONV", ModuleConstants.kTurningDegreesPerEncRev);
